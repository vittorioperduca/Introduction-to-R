...
```{r}
url1 <- 'https://raw.githubusercontent.com/vittorioperduca/Introduction-to-R/devel/data/iris.txt'
d1 <- read.table(url1,
...
url2 <- 'https://raw.githubusercontent.com/vittorioperduca/Introduction-to-R/devel/data/heart.txt'
d2 <- read.table(url2,
                 header = TRUE,
...
For data stored in the `.Rda` or `.Rdata` format, the import is done with `load()` with the argument `file = filename`. For instance download the `Iris.Rda` file at [github.com/vittorioperduca/Introduction-to-R/blob/devel/data/Iris.Rda](https://github.com/vittorioperduca/Introduction-to-R/blob/devel/data/Iris.Rda) to your working directory and then try the following:
...
Download the text file [raw.githubusercontent.com/vittorioperduca/Introduction-to-R/devel/data/hepatitis.txt](https://raw.githubusercontent.com/vittorioperduca/Introduction-to-R/devel/data/hepatitis.txt) to your working directory.
